...
describe('favourite blog', () => {
    test('of empty list is an empty object', () => {
        expect(listHelper.favoriteBlog([], 'likes')).toEqual({})
    })
    
    test('of list with one element is the element itself', () => {
        expect(listHelper.favoriteBlog(listWithOneBlog, 'likes')).toEqual({
            title: 'Go To Statement Considered Harmful',
            author: 'Edsger W. Dijkstra',
            likes: 5
        })
    ...
    test('of a bigger list is finded correctly', () => {
        expect(listHelper.favoriteBlog(listWithMultipleBlogs, 'likes')).toEqual({
            title: 'Canonical string reduction',
            author: 'Edsger W. Dijkstra',
            likes: 12
        })
